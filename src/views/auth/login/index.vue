<template>
  <div class="w-full h-screen flex p-6">
    ...
    <div
      class="flex-1 rounded-r-xl w-3/5 object-cover bg-center">
      <img :src="Gambar" alt="" class="absolute w-[700px] rounded-r-xl -translate-x-20">
      </div>
      <div class="p-6 mb-20">
        <p class="font-Plus-Jakarta-Sans text-Grayscale-50 font-medium text-lg fixed w-[552px]">Desain yang user-friendly membuat navigasi cepat dan mudah, bahkan bagi pemula.</p>
      </div>
    </div>
    <!-- kanan -->
    <div class="w-[558px] flex flex-col justify-center p-6 gap-y-4 ">
      ...
      <div class="w-[510px] gap-y-6">
        <h1 class="font-Plus-Jakarta-Sans text-gray-950 text-[30px] font-medium">Selamat Datang di MASPOS</h1>
        <p class="font-Plus-Jakarta-Sans text-[20px]">Masuk untuk mengelola bisnis Anda dengan mudah dan efisien. MASPOS menghadirkan solusi
            point-of-sale terbaik untuk kemudahan operasional sehari-hari.</p>
      </div>
